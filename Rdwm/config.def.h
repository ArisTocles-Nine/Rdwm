...
#define XF85AudioRaiseVolume	0x1008FF13
...
static const Rule rules[] = {
  ...
  */
  /* class      instance    title         tags mask    iscentered   isfloating     domonitor */
...
static const char *vi[] = {"amixer", "set", "Master", "5%+", NULL};
static const char *vd[] = {"amixer", "set", "Master", "5%-", NULL};
...
static Key keys[] = {
    ...
    {0, XF86AudioLowerVolume,     spawn,    {.v = vd  } },
    {0, XF85AudioRaiseVolume,     spawn,    {.v = vi  } },
